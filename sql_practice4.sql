...
select * from calisanlar; ---calisanlar için birlesme yeri isyeri
select * from markalar; --- birlesme yeri marka_isim
...
where isyeri in (select marka_isim from  markalar where calisan_sayisi>15000); --baglantı noktasi
